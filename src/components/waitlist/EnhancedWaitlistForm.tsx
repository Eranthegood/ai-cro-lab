...
const EnhancedWaitlistForm = ({
    ...
    return <div className={`space-y-6 ${className}`}>
        <form onSubmit={handleEmailSubmit} className="max-w-lg mx-auto">
          <div className="flex gap-3">
            ...
            <Button type="submit" size="lg" className="h-14 px-8 text-base font-semibold bg-white text-primary hover:bg-white/90 transition-all duration-200">
  ...
  return <div className={`space-y-6 ${className}`}>
      ...
      <form onSubmit={handleQualificationSubmit} className="space-y-4 max-w-md mx-auto">
        ...
        <Button type="submit" disabled={isSubmitting} size="lg" className="w-full h-12 text-base font-semibold bg-white text-primary hover:bg-white/90 transition-all duration-200">
          {isSubmitting ? <>
