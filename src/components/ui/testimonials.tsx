                ...
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div className="relative">
                        ...
                        <div className="absolute inset-0 -z-10 opacity-10">
                            <div className="h-full w-full rounded-lg bg-muted/20 p-6 flex flex-col">
                                <div className="absolute top-4 right-4 text-xs font-medium text-muted-foreground/60">Testing Velocity</div>
