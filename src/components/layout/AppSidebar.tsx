...
const AppSidebar = () => {
  ...
  const isABTestingRoute = (path: string) => {
    return path.startsWith('/dashboard/ab-testing') || path === '/ab-test-generator' || path === '/ab-test-history' || path === '/ab-test-backlog';
  };
  ...
  const menuItems = [
    ...
    { 
      ...
      submenu: [
        ...
        { title: "Backlog", url: "/ab-test-backlog", icon: BookOpen },
