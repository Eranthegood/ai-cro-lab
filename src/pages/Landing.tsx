...
const Landing = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section id="platform" className="py-24 border-t border-border bg-muted/20">
        <div className="container max-w-4xl mx-auto px-8 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-6">Feature : The Intelligence Vault

A persistent knowledge layer that learns from your data, tests, and results to generate increasingly sophisticated experiment recommendations.</h2>
          ...
          <div className="bg-background border border-border rounded-lg p-12">
            ...
            <div className="grid grid-cols-4 gap-8 mb-8">
              {['Data', 'Tests', 'Results', 'Context'].map((label, index) => <div key={index} className="text-center">
